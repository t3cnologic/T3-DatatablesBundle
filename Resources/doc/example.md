...
class PostDatatable extends AbstractDatatableView
{
    ...
    public function buildDatatableView()
    {
        ...
        // Options (for more options see file: T3\DatatablesBundle\Datatable\View\Options.php)
...
```html
{% extends 'T3BlogBundle::layout.html.twig' %}
...
services:
    ...
    t3_datatables.post:
        class: T3\BlogBundle\Datatables\PostDatatable
        tags:
            - { name: t3.datatable.view }
```
...
{
    $postDatatable = $this->get("t3_datatables.post");
...
{
    /**
     * @var \T3\DatatablesBundle\Datatable\Data\DatatableData $datatable
     */
    $datatable = $this->get("t3_datatables.datatable")->getDatatable($this->get("t3_datatables.post"));
...
public function bulkDeleteAction()
{
    ...
    if ($isAjax) {
        ...
        $repository = $em->getRepository("T3BlogBundle:Post");
...
public function indexAction()
{
    $repository = $this->getDoctrine()->getRepository('T3BlogBundle:Post');
